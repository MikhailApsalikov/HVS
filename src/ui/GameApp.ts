...
import { AntiAfkOverlay } from './overlays/AntiAfkOverlay.js';
import { PreparationOverlay } from './overlays/PreparationOverlay.js';
...
export class GameApp {
  ...
  private readonly preparation: PreparationOverlay;
