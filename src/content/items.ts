...
const COMMON_ITEMS: readonly ItemConfig[] = [
  ...
  { id: 'c025', name: 'Паучий антидот', rarity: 'common', stats: [{ type: 'hpRegen', value: 5 }] },
  {
    ...
    rarity: 'common',
    stats: [{ type: 'hpRegen', value: 7 }],
  },
  {
    id: 'c030',
    name: 'Концентрированный бальзам',
    rarity: 'common',
    stats: [{ type: 'hpRegen', value: 10 }],
  },
  {
    id: 'c035',
    name: 'Священный бальзам',
    rarity: 'common',
    stats: [{ type: 'hpRegen', value: 15 }],
  },
  ...
  // ── % снижение урона (N 1–15) ──────────────────────────────────────────
  {
    ...
    rarity: 'common',
    stats: [{ type: 'damageReduction', value: 3 }],
  },
  {
    id: 'c046',
    name: 'Рунный щит',
    rarity: 'common',
    stats: [{ type: 'damageReduction', value: 6 }],
  },
  {
    id: 'c050',
    name: 'Укреплённый доспех',
    rarity: 'common',
    stats: [{ type: 'damageReduction', value: 10 }],
  },
  {
    id: 'c052',
    name: 'Рыцарские поножи',
    rarity: 'common',
    stats: [{ type: 'damageReduction', value: 12 }],
  },
  {
    id: 'c055',
    name: 'Адамантовый щит',
    rarity: 'common',
    stats: [{ type: 'damageReduction', value: 15 }],
  },
...
const RARE_ITEMS: readonly ItemConfig[] = [
  ...
  { id: 'r007', name: 'Зелье бессмертия', rarity: 'rare', stats: [{ type: 'hpRegen', value: 28 }] },
  {
    ...
    rarity: 'rare',
    stats: [{ type: 'damageReduction', value: 18 }],
  },
  {
    id: 'r009',
    name: 'Зачарованный щит',
    rarity: 'rare',
    stats: [{ type: 'damageReduction', value: 22 }],
  },
  {
    id: 'r010',
    name: 'Несокрушимый доспех',
    rarity: 'rare',
    stats: [{ type: 'damageReduction', value: 28 }],
  },
...
const EPIC_ITEMS: readonly ItemConfig[] = [
  ...
  { id: 'e003', name: 'Живой источник', rarity: 'epic', stats: [{ type: 'hpRegen', value: 50 }] },
  {
    ...
    name: 'Щит предков',
    rarity: 'epic',
    stats: [{ type: 'damageReduction', value: 33 }],
  },
  {
    id: 'e005',
...
const LEGENDARY_ITEMS: readonly ItemConfig[] = [
  ...
  // ── Залп (3 предмета) ─────────────────────────────────────────────────────
  {
    ...
    abilityMod: {
      ...
      modType: 'effectBoost',
      value: 4,
      description: '«Залп»: +4 дополнительные линии',
    },
  },
  {
    id: 'l008',
