...
`,O=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  ...
  <!-- Shaft (vertical, pointing up) -->
  <rect x="30" y="12" width="4" height="44" rx="1" fill="url(#arrowShaft)"/>
  <!-- Arrowhead (pointing up) -->
  <path d="M32 0 L24 12 L40 12 Z" fill="url(#arrowHead)"/>
  <path d="M32 0 L24 12 L40 12 Z" fill="none" stroke="#606060" stroke-width="0.5"/>
  <!-- Fletching - feathers (at bottom) -->
  <path d="M32 56 L24 64 Q32 60 40 64 Z" fill="url(#arrowFeather)"/>
  <path d="M32 56 L28 64 Q32 61 36 64 Z" fill="url(#arrowFeather)" opacity="0.9"/>
  <path d="M32 56 L26 64 Q32 60.5 38 64 Z" fill="url(#arrowFeather)" opacity="0.85"/>
</svg>
`,U=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <defs>
...
`,K=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
  <defs>
...
`,Y=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
  <defs>
...
`,te=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <defs>
...
`,ne=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <defs>
...
`,ue=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
  <defs>
...
`,_e=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
  <defs>
...
`;class ge{_sprites=new Map;loadAll(){const e=Object.assign({"../sprites/Archer.svg":$,"../sprites/Arrow.svg":O,"../sprites/Castle.svg":U,"../sprites/abilities/AbilityArmageddon.svg":Z,"../sprites/abilities/AbilityBlizzard.svg":j,"../sprites/abilities/AbilityFreeze.svg":q,"../sprites/abilities/AbilityHeal.svg":V,"../sprites/abilities/AbilityPrep.svg":K,"../sprites/abilities/AbilityStand.svg":Y,"../sprites/abilities/AbilityVolley.svg":J,"../sprites/spiders/SpiderBurner.svg":W,"../sprites/spiders/SpiderFast.svg":X,"../sprites/spiders/SpiderFat.svg":ee,"../sprites/spiders/SpiderNinja.svg":te,"../sprites/spiders/SpiderNormal.svg":ne,"../sprites/talents/TalentAgility.svg":se,"../sprites/talents/TalentArmor.svg":re,"../sprites/talents/TalentBlizzardMastery.svg":ie,"../sprites/talents/TalentDuty.svg":oe,"../sprites/talents/TalentEndurance.svg":le,"../sprites/talents/TalentHealBoost.svg":ae,"../sprites/talents/TalentHunter.svg":de,"../sprites/talents/TalentPrep.svg":ce,"../sprites/talents/TalentRapidFire.svg":pe,"../sprites/talents/TalentTireless.svg":he,"../sprites/talents/TalentVolleyMastery.svg":fe,"../sprites/ui/Lock.svg":ye,"../sprites/ui/Shield.svg":ue,"../sprites/ui/Snowflake.svg":_e});for(const[t,n]of Object.entries(e)){const s=t.split("/").pop().replace(".svg","");this._sprites.set(s,n)}}get(e){return this._sprites.get(e)??""}}class me{_container;_loadButton;_onStartGame;_onLoadGame;constructor(e,t,n){this._container=e,this._onStartGame=t,this._onLoadGame=n,this._loadButton=document.createElement("button"),this._build()}_build(){this._container.className="main-menu-screen",this._container.dataset.screen="main-menu";const e=document.createElement("h1");e.className="main-menu__title",e.textContent="ЗАЩИТА ЗАМКА",this._container.appendChild(e);const t=document.createElement("p");t.className="main-menu__subtitle",t.textContent="Лучники против пауков",this._container.appendChild(t);const n=document.createElement("div");n.className="main-menu__buttons",this._loadButton.className="main-menu__btn main-menu__btn--load",this._loadButton.textContent="Загрузить игру",this._loadButton.dataset.action="load",this._loadButton.addEventListener("click",()=>this._onLoadGame()),n.appendChild(this._loadButton);const s=[{key:"easy",label:"Лёгкий"},{key:"normal",label:"Средний"},{key:"hard",label:"Сложный"}];for(const{key:r,label:i}of s){const o=document.createElement("button");o.className="main-menu__btn main-menu__btn--difficulty",o.type="button",o.textContent=i,o.dataset.difficulty=r,o.dataset.action="start",o.addEventListener("click",()=>this._onStartGame(r)),n.appendChild(o)}this._container.appendChild(n)}render(e){this._loadButton.classList.toggle("main-menu__btn--hidden",!e),this._loadButton.hidden=!e}getContainer(){return this._container}}const we={normal:"SpiderNormal",fat:"SpiderFat",fast:"SpiderFast",ninja:"SpiderNinja",burner:"SpiderBurner"};class ve{_container;_lanesArea;_archersRow;_lanes=[];_spiderElements=new Map;_arrowElements=new Map;_archerButtons=[];_spriteRegistry;constructor(e,t){this._container=e,this._spriteRegistry=t,this._lanesArea=document.createElement("div"),this._archersRow=document.createElement("div"),this._build()}_build(){this._container.className="game-field",this._container.dataset.component="game-field",this._lanesArea.className="game-field__lanes";for(let e=0;e<9;e++){const t=document.createElement("div");t.className="lane",t.dataset.lane=String(e),this._lanesArea.appendChild(t),this._lanes.push(t)}this._container.appendChild(this._lanesArea),this._archersRow.className="game-field__archers";for(let e=0;e<9;e++){const t=document.createElement("button");t.className="archer-btn",t.dataset.lane=String(e),t.type="button";const n=document.createElement("span");n.className="archer-btn__number",n.textContent=String(e+1),t.appendChild(n);const s=document.createElement("span");s.className="archer-btn__icon",s.innerHTML=this._spriteRegistry.get("Archer"),t.appendChild(s),this._archerButtons.push(t),this._archersRow.appendChild(t)}this._container.appendChild(this._archersRow)}render(e){this._renderSpiders(e),this._renderArrows(e),this._renderArchers(e)}_renderArchers(e){const t=e.archers;for(let n=0;n<this._archerButtons.length;n++){const s=t[n],r=this._archerButtons[n];if(s&&r){const i=s.cooldownFraction*100;r.style.setProperty("--cd-pct",`${i}%`),r.classList.toggle("archer-btn--cooldown",!s.isReady)}}}_renderSpiders(e){const t=new Set;for(const n of e.spiders.values()){t.add(n.id);let s=this._spiderElements.get(n.id);if(!s){s=this._createSpiderElement(n),this._spiderElements.set(n.id,s);const i=this._lanes[n.lane];i&&i.appendChild(s)}if(parseInt(s.dataset.lane??"-1",10)!==n.lane){s.dataset.lane=String(n.lane);const i=this._lanes[n.lane];i&&i.appendChild(s)}s.style.setProperty("--y",String(n.y)),s.classList.toggle("spider--slowed",n.slowFactor<1),s.classList.toggle("spider--dying",n.dying)}for(const[n,s]of this._spiderElements)t.has(n)||(s.remove(),this._spiderElements.delete(n))}_createSpiderElement(e){const t=document.createElement("div");t.className="spider spider--walk",t.dataset.spiderId=e.id,t.dataset.lane=String(e.lane);const n=we[e.type]??"SpiderNormal";return t.innerHTML=this._spriteRegistry.get(n),t}_renderArrows(e){const t=new Set;for(const n of e.arrows.values()){t.add(n.id);let s=this._arrowElements.get(n.id);if(!s){s=this._createArrowElement(),this._arrowElements.set(n.id,s);const r=this._lanes[n.lane];r&&r.appendChild(s)}s.style.setProperty("--y",String(n.y))}for(const[n,s]of this._arrowElements)t.has(n)||(s.remove(),this._arrowElements.delete(n))}_createArrowElement(){const e=document.createElement("div");return e.className="arrow",e.innerHTML=this._spriteRegistry.get("Arrow"),e}getContainer(){return this._container}getArchersRow(){return this._archersRow}}const S=["freeze","blizzard","prep","heal","volley","stand","armageddon"],A={freeze:"Заморозка времени",blizzard:"Вьюга",prep:"Подготовка",heal:"Лечение",volley:"Залп",stand:"Ни шагу назад!",armageddon:"Армагеддон"},G={freeze:"Q",blizzard:"W",prep:"E",heal:"R",volley:"T",stand:"Y",armageddon:"U"},xe={freeze:4,blizzard:8,prep:12,heal:16,volley:20,stand:24,armageddon:28},ke={freeze:"Полностью останавливает игру. Повторное нажатие Q — возобновляет бесплатно.",blizzard:"Замедляет всех пауков на поле.",prep:"Мгновенно восстанавливает 300 энергии.",heal:"Мгновенно восстанавливает HP.",volley:"Выпускает стрелы из случайных линий.",stand:"Полная неуязвимость на время действия.",armageddon:"Все пауки на поле постепенно сгорают (задержка 1.7 сек)."},be={freeze:"AbilityFreeze",blizzard:"AbilityBlizzard",prep:"AbilityPrep",heal:"AbilityHeal",volley:"AbilityVolley",stand:"AbilityStand",armageddon:"AbilityArmageddon"};class Se{_container;_hpFill=null;_hpText=null;_energyFill=null;_energyText=null;_coinsDisplay=null;_levelTimerDisplay=null;_levelNumberDisplay=null;_abilityButtons=[];_abilityTooltips=new Map;_shootTooltip=null;_spriteRegistry;_talentSystem=null;constructor(e,t){this._container=e,this._spriteRegistry=t,this._build()}setTalentSystem(e){this._talentSystem=e}_build(){this._container.className="hud",this._container.dataset.component="hud";const e=document.createElement("div");e.id="resource-bars",e.className="resource-bars";const t=this._createResourceBar("hp-bar","HP");this._hpFill=t.querySelector(".resource-bar__fill"),this._hpText=t.querySelector(".resource-bar__text"),e.appendChild(t);const n=this._createResourceBar("energy-bar","Энергия");this._energyFill=n.querySelector(".resource-bar__fill"),this._energyText=n.querySelector(".resource-bar__text"),e.appendChild(n),this._container.appendChild(e),this._coinsDisplay=document.createElement("div"),this._coinsDisplay.id="coins-display",this._coinsDisplay.className="coins-display",this._container.appendChild(this._coinsDisplay),this._levelTimerDisplay=document.createElement("div"),this._levelTimerDisplay.id="level-timer",this._levelTimerDisplay.className="level-timer",this._container.appendChild(this._levelTimerDisplay),this._levelNumberDisplay=document.createElement("div"),this._levelNumberDisplay.id="level-number",this._levelNumberDisplay.className="level-number",this._container.appendChild(this._levelNumberDisplay);const s=document.createElement("div");s.className="hud__shoot-info",s.innerHTML='<span class="hud__shoot-label">Выстрел [1-9]</span>',this._shootTooltip=document.createElement("div"),this._shootTooltip.className="tooltip tooltip--shoot",s.appendChild(this._shootTooltip),s.addEventListener("mouseenter",()=>this._updateShootTooltip()),this._container.appendChild(s);const r=document.createElement("div");r.id="ability-buttons",r.className="ability-buttons";for(const i of S){const o=this._createAbilityButton(i);this._abilityButtons.push(o),r.appendChild(o)}this._container.appendChild(r)}_createResourceBar(e,t){const n=document.createElement("div");return n.id=e,n.className="resource-bar",n.innerHTML=`
      <div class="resource-bar__fill" style="--fill: 100%"></div>
      <div class="resource-bar__text">0 / 0</div>
    `,n}_createAbilityButton(e){const t=document.createElement("div");t.className="ability-btn-wrapper";const n=document.createElement("button");n.className="ability-btn",n.dataset.ability=e,n.type="button";const s=document.createElement("span");s.className="ability-btn__icon",s.innerHTML=this._spriteRegistry.get(be[e]),n.appendChild(s);const r=document.createElement("span");r.className="ability-btn__info",r.innerHTML=`<span class="ability-btn__name">${A[e]}</span>
      <span class="ability-btn__hotkey">[${G[e]}]</span>`,n.appendChild(r);const i=document.createElement("span");i.className="ability-btn__cd-text",n.appendChild(i),t.appendChild(n);const o=document.createElement("div");return o.className="tooltip tooltip--ability",t.appendChild(o),this._abilityTooltips.set(e,o),t.addEventListener("mouseenter",()=>this._updateAbilityTooltip(e)),t}_updateShootTooltip(){if(!this._shootTooltip||!this._talentSystem)return;const e=this._talentSystem,n=35-e.getShootCostReduction(),r=1.5*e.getShootCooldownMultiplier(),o=1.5/e.getArrowSpeedMultiplier();this._shootTooltip.innerHTML=`
      ...
      <div class="tooltip__stat">Стоимость: <b>${n}</b> энергии</div>
      <div class="tooltip__stat">Кулдаун: <b>${r.toFixed(2)}</b> сек</div>
      <div class="tooltip__stat">Время полёта: <b>${o.toFixed(2)}</b> сек</div>
      ${e.getShootCostReduction()>0?`<div class="tooltip__talent">Мастерство охотника: −${e.getShootCostReduction()} стоимость</div>`:""}
      ${e.getRank("rapidFire")>0?`<div class="tooltip__talent">Скорострельность: −${e.getRank("rapidFire")*10}% кулдаун, +${e.getRank("rapidFire")*10}% скорость</div>`:""}
    `}_updateAbilityTooltip(e){const t=this._abilityTooltips.get(e);if(!t)return;const n=this._talentSystem,s=xe[e],r=A[e],i=G[e],o=ke[e];let d="";n&&(d=this._getAbilityStatsHtml(e,n)),t.innerHTML=`
      <div class="tooltip__title">${r} [${i}]</div>
      <div class="tooltip__desc">${o}</div>
      <div class="tooltip__stat">Открывается: <b>уровень ${s}</b></div>
      ${d}
    `}_getAbilityStatsHtml(e,t){switch(e){case"freeze":return`<div class="tooltip__stat">Стоимость: <b>50</b> энергии</div>
                <div class="tooltip__stat">Кулдаун: <b>нет</b></div>`;case"blizzard":{const n=40+t.getBlizzardSlowBonus()*100,s=4+t.getBlizzardDurationBonus();return`<div class="tooltip__stat">Стоимость: <b>40</b> энергии</div>
                <div class="tooltip__stat">Кулдаун: <b>15</b> сек</div>
                <div class="tooltip__stat">Замедление: <b>${n.toFixed(0)}%</b></div>
                <div class="tooltip__stat">Длительность: <b>${s}</b> сек</div>
                ${t.getRank("blizzardMastery")>0?`<div class="tooltip__talent">Беспощадная вьюга: +${t.getRank("blizzardMastery")*7}% замедл., +${t.getRank("blizzardMastery")} сек</div>`:""}`}case"prep":return`<div class="tooltip__stat">Стоимость: <b>0</b> энергии</div>
                <div class="tooltip__stat">Кулдаун: <b>${60-t.getPrepCooldownReduction()}</b> сек</div>
                <div class="tooltip__stat">Восстанавливает: <b>300</b> энергии</div>
                ${t.getRank("improvedPrep")>0?`<div class="tooltip__talent">Улучш. подготовка: −${t.getPrepCooldownReduction()} сек кулдаун</div>`:""}`;case"heal":return`<div class="tooltip__stat">Стоимость: <b>100</b> энергии</div>
                <div class="tooltip__stat">Кулдаун: <b>10</b> сек</div>
                <div class="tooltip__stat">Восстанавливает: <b>${150+t.getHealBonus()}</b> HP</div>
                ${t.getRank("healBoost")>0?`<div class="tooltip__talent">Усил. лечение: +${t.getHealBonus()} HP, +${t.getHpRegenBonus()} HP/сек</div>`:""}`;case"volley":{const n=4+t.getVolleyExtraLanes();return`<div class="tooltip__stat">Стоимость: <b>100</b> энергии</div>
                <div class="tooltip__stat">Кулдаун: <b>${(12*t.getShootCooldownMultiplier()).toFixed(1)}</b> сек</div>
                <div class="tooltip__stat">Линий: <b>${n}</b></div>
                ${t.getRank("volleyMastery")>0?`<div class="tooltip__talent">Искусный залп: +${t.getVolleyExtraLanes()} линий</div>`:""}
                ${t.getRank("rapidFire")>0?`<div class="tooltip__talent">Скорострельность: −${t.getRank("rapidFire")*10}% кулдаун</div>`:""}`}case"stand":{const n=7+t.getStandDurationBonus();return`<div class="tooltip__stat">Стоимость: <b>15</b> энергии</div>
                <div class="tooltip__stat">Кулдаун: <b>${120-t.getStandCooldownReduction()}</b> сек</div>
                <div class="tooltip__stat">Длительность: <b>${n}</b> сек</div>
                ${t.getRank("dutyBound")>0?`<div class="tooltip__talent">Чувство долга: +${t.getStandDurationBonus()} сек, −${t.getStandCooldownReduction()} сек кд</div>`:""}`}case"armageddon":return`<div class="tooltip__stat">Стоимость: <b>100</b> энергии</div>
                <div class="tooltip__stat">Кулдаун: <b>120</b> сек</div>
                <div class="tooltip__stat">Задержка: <b>1.7</b> сек, затем <b>2</b> сек горения</div>`;default:return""}}render(e){const t=e.maxHp>0?e.hp/e.maxHp*100:0;this._hpFill&&this._hpFill.style.setProperty("--fill",`${t}%`),this._hpText&&(this._hpText.textContent=`${Math.floor(e.hp)} / ${Math.floor(e.maxHp)}`);const n=e.maxEnergy>0?e.energy/e.maxEnergy*100:0;this._energyFill&&this._energyFill.style.setProperty("--fill",`${n}%`),this._energyText&&(this._energyText.textContent=`${Math.floor(e.energy)} / ${Math.floor(e.maxEnergy)}`),this._coinsDisplay&&(this._coinsDisplay.textContent=`Монетки: ${Math.floor(e.coins)}`),this._levelTimerDisplay&&(this._levelTimerDisplay.textContent=`Таймер: ${Math.ceil(e.levelTimer)}с`),this._levelNumberDisplay&&(this._levelNumberDisplay.textContent=`Уровень ${e.level}`);for(let s=0;s<S.length;s++){const r=S[s],i=e.getAbility(r),o=this._abilityButtons[s];if(!i||!o)continue;const d=o.querySelector(".ability-btn");if(!d)continue;const c=i.isAvailableAt(e.level);d.classList.toggle("ability-btn--locked",!c),d.style.setProperty("--cd-pct",`${i.cooldownFraction*100}%`),d.classList.toggle("ability-btn--cooldown",i.isOnCooldown);const _=d.querySelector(".ability-btn__cd-text");_&&(_.textContent=i.isOnCooldown&&i.remainingCooldown>0?`${Math.ceil(i.remainingCooldown)}с`:"");let y=d.querySelector(".ability-btn__lock");if(!c&&!y){const a=document.createElement("span");a.className="ability-btn__lock",a.innerHTML=this._spriteRegistry.get("Lock"),d.appendChild(a)}else c&&y&&y.remove()}}getContainer(){return this._container}getAbilityButtonsContainer(){return this._container.querySelector("#ability-buttons")??this._container}}class Le{_container;_gameField;_hud;constructor(e,t){this._container=e,this._gameField=new ve(this._createGameFieldContainer(),t),this._hud=new Se(this._createHudContainer(),t),this._build()}_createGameFieldContainer(){const e=document.createElement("div");return e.id="game-field",e.className="game-field-wrapper",e}_createHudContainer(){const e=document.createElement("div");return e.id="hud",e.className="hud-wrapper",e}_build(){this._container.className="game-screen",this._container.dataset.screen="game";const e=this._gameField.getContainer();this._container.appendChild(e);const t=this._hud.getContainer();this._container.appendChild(t)}render(e){this._gameField.render(e),this._hud.render(e)}getContainer(){return this._container}getGameField(){return this._gameField}getHud(){return this._hud}}class Me{_container;_titleEl;_levelEl;_recordEl;_onReturnToMenu;constructor(e,t){this._container=e,this._onReturnToMenu=t,this._titleEl=document.createElement("h1"),this._levelEl=document.createElement("p"),this._recordEl=document.createElement("p"),this._build()}_build(){this._container.className="game-over-screen",this._container.dataset.screen="game-over",this._titleEl.className="game-over__title",this._container.appendChild(this._titleEl),this._levelEl.className="game-over__level",this._container.appendChild(this._levelEl),this._recordEl.className="game-over__record",this._container.appendChild(this._recordEl);const e=document.createElement("button");e.className="game-over__btn",e.type="button",e.textContent="В меню",e.dataset.action="menu",e.addEventListener("click",()=>this._onReturnToMenu()),this._container.appendChild(e)}render(e,t,n){this._titleEl.textContent=n?"НОВЫЙ РЕКОРД!":"ПОРАЖЕНИЕ",this._titleEl.classList.toggle("game-over__title--victory",n),this._titleEl.classList.toggle("game-over__title--defeat",!n),this._levelEl.textContent=`Вы пали на уровне ${e}`,this._recordEl.textContent=`Рекорд: ${t}`}getContainer(){return this._container}}const Ce={endurance:"Выносливость",spiderArmor:"Защита от пауков",tireless:"Неутомимость",agility:"Ловкость",healBoost:"Усиленное лечение",hunterMastery:"Мастерство охотника",improvedPrep:"Улучшенная подготовка",volleyMastery:"Искусный залп",rapidFire:"Скорострельность",dutyBound:"Чувство долга",blizzardMastery:"Беспощадная вьюга"},Te={endurance:"+425 макс. HP",spiderArmor:"-7% получаемого урона",tireless:"+10% регенерации энергии",agility:"+120 макс. энергии",healBoost:"+150 HP от Лечения, +2 HP/сек",hunterMastery:"-2 стоимость выстрела",improvedPrep:"-6 сек кулдаун Подготовки",volleyMastery:"+1 орудие в Залпе",rapidFire:"-10% кулдаун выстрела/залпа, +10% скорость стрел",dutyBound:"+1с длительность и -12с кулдаун Ни шагу назад!",blizzardMastery:"+7% замедление и +1с длительность Вьюги"},Be={endurance:"TalentEndurance",spiderArmor:"TalentArmor",tireless:"TalentTireless",agility:"TalentAgility",healBoost:"TalentHealBoost",hunterMastery:"TalentHunter",improvedPrep:"TalentPrep",volleyMastery:"TalentVolleyMastery",rapidFire:"TalentRapidFire",dutyBound:"TalentDuty",blizzardMastery:"TalentBlizzardMastery"};class Ee{_container;_levelEl;_talentsGrid;_confirmBtn;_onConfirm=null;_onTalentUpgrade=null;_pendingPoints=0;_talentSystem=null;_playerLevel=1;_spriteRegistry;constructor(e,t){this._container=e,this._spriteRegistry=t,this._levelEl=document.createElement("h2"),this._talentsGrid=document.createElement("div"),this._confirmBtn=document.createElement("button"),this._build()}_build(){this._container.className="level-up-screen",this._container.dataset.screen="level-up",this._levelEl.className="level-up__title",this._container.appendChild(this._levelEl),this._talentsGrid.className="level-up__talents",this._talentsGrid.dataset.component="talents-grid",this._container.appendChild(this._talentsGrid),this._confirmBtn.className="level-up__confirm",this._confirmBtn.textContent="Продолжить",this._confirmBtn.dataset.action="confirm",this._confirmBtn.addEventListener("click",()=>this._handleConfirm()),this._container.appendChild(this._confirmBtn)}show(e,t,n,s,r){this._onTalentUpgrade=r??null,this._playerLevel=e,this._talentSystem=t,this._pendingPoints=n,this._onConfirm=s,this._levelEl.textContent=`Уровень ${e} пройден!`,this._renderTalents(),this._updateConfirmState(),this._container.classList.add("level-up-screen--visible")}hide(){this._container.classList.remove("level-up-screen--visible"),this._onConfirm=null,this._talentSystem=null}_renderTalents(){this._talentsGrid.innerHTML="";const e=this._talentSystem;if(!e)return;const t=[...e.talents].sort((n,s)=>n.unlocksAtLevel-s.unlocksAtLevel);for(const n of t){const s=this._createTalentCard(n.id,n.rank,n.maxRanks,n.unlocksAtLevel);this._talentsGrid.appendChild(s)}}_createTalentCard(e,t,n,s){const r=document.createElement("div");r.className="talent-card",r.dataset.talentId=e;const o=this._talentSystem.canUpgrade(e,this._playerLevel),d=this._pendingPoints>0,c=document.createElement("div");c.className="talent-card__icon",c.innerHTML=this._spriteRegistry.get(Be[e]),r.appendChild(c);const _=document.createElement("div");_.className="talent-card__name",_.textContent=Ce[e],r.appendChild(_);const y=document.createElement("div");y.className="talent-card__desc",y.textContent=Te[e],r.appendChild(y);const a=document.createElement("div");a.className="talent-card__rank",a.textContent=`${t} / ${n}`,r.appendChild(a);const h=document.createElement("button");return h.className="talent-card__upgrade",h.type="button",h.textContent="Улучшить",h.dataset.talentId=e,h.disabled=!o||!d,h.addEventListener("click",()=>this._handleUpgrade(e)),r.appendChild(h),this._playerLevel<s&&(r.classList.add("talent-card--locked"),h.textContent=`Разблокируется на ${s} ур.`),r}_handleUpgrade(e){const t=this._talentSystem;!t||this._pendingPoints<=0||t.canUpgrade(e,this._playerLevel)&&(t.upgrade(e),this._pendingPoints-=1,this._onTalentUpgrade?.(e),this._renderTalents(),this._updateConfirmState())}_handleConfirm(){this._canConfirm()&&this._onConfirm?.()}_canConfirm(){if(this._pendingPoints<=0)return!0;const e=this._talentSystem;return e?!e.hasAvailableUpgrades(this._playerLevel):!0}_updateConfirmState(){this._confirmBtn.disabled=!this._canConfirm()}getContainer(){return this._container}}class Ae{_root;_menuScreen;_gameScreen;_gameOverScreen;_levelUpScreen;_engine=null;_saveSystem=null;constructor(e,t){this._root=e;const n=document.createElement("div");this._menuScreen=new me(n,o=>this.startNewGame(o),()=>this.loadGame());const s=document.createElement("div");this._gameScreen=new Le(s,t);const r=document.createElement("div");this._gameOverScreen=new Me(r,()=>this._showScreen("menu"));const i=document.createElement("div");this._levelUpScreen=new Ee(i,t)}setEngine(e){this._engine=e}setSaveSystem(e){this._saveSystem=e}init(){this._root.innerHTML="",this._root.className="app";const e=document.createElement("div");e.className="app__screens",e.appendChild(this._menuScreen.getContainer()),e.appendChild(this._gameScreen.getContainer()),e.appendChild(this._gameOverScreen.getContainer()),this._root.appendChild(e),this._root.appendChild(this._levelUpScreen.getContainer()),this._menuScreen.render(this._saveSystem?.hasSave()??!1),this._showScreen("menu")}_showScreen(e){this._root.querySelectorAll("[data-screen]").forEach(r=>r.classList.remove("screen--active"));const n={menu:"main-menu",game:"game",gameover:"game-over"};this._root.querySelector(`[data-screen="${n[e]}"]`)?.classList.add("screen--active")}startNewGame(e){this._engine?.startNewGame(e),this._menuScreen.render(this._saveSystem?.hasSave()??!1),this._showScreen("game")}loadGame(){this._engine?.loadGame(),this._menuScreen.render(this._saveSystem?.hasSave()??!1),this._showScreen("game")}showGameOver(e,t,n){this._gameOverScreen.render(e,t,n),this._showScreen("gameover")}showLevelUp(e,t,n,s,r){this._levelUpScreen.show(e,t,n,s,r)}renderGameState(e){this._gameScreen.render(e)}getGameScreen(){return this._gameScreen}getLevelUpScreen(){return this._levelUpScreen}}class Ge{id;unlockedAtLevel;_cooldown;_maxCooldown;constructor(e,t,n){this.id=e,this.unlockedAtLevel=t,this._cooldown=0,this._maxCooldown=n}get isOnCooldown(){return this._cooldown>0}get cooldownFraction(){return Math.min(Math.max(this._cooldown/this._maxCooldown,0),1)}get remainingCooldown(){return this._cooldown}get maxCooldown(){return this._maxCooldown}activate(e){this._cooldown=e}tick(e){this._cooldown-=e,this._cooldown<0&&(this._cooldown=0)}isAvailableAt(e){return e>=this.unlockedAtLevel}updateMaxCooldown(e){this._maxCooldown=e}}class ze{_lane;_cooldown;_maxCooldown;constructor(e,t){this._lane=e,this._cooldown=0,this._maxCooldown=t}get lane(){return this._lane}get cooldown(){return this._cooldown}get maxCooldown(){return this._maxCooldown}get isReady(){return this._cooldown<=0}get cooldownFraction(){return Math.min(Math.max(this._cooldown/this._maxCooldown,0),1)}get remainingCooldown(){return this._cooldown}startCooldown(e){this._cooldown=e}tick(e){this._cooldown-=e,this._cooldown<0&&(this._cooldown=0)}updateMaxCooldown(e){this._maxCooldown=e}}const Re={freeze:4,blizzard:8,prep:12,heal:16,volley:20,stand:24,armageddon:28};class v{_phase;_difficulty;_level;_levelTimer;_hp;_maxHp;_energy;_maxEnergy;_coins;_pendingTalentPoints;_archers;_spiders;_arrows;_abilities;_isInvulnerable;_invulnerableTimer;_freezeActive;_blizzardActive;_blizzardTimer;_armageddonPhase;_armageddonTimer;_record;_config;constructor(e,t,n,s){this._phase="menu",this._difficulty=e,this._level=1,this._levelTimer=t.levelTimerBase+t.levelTimerStep*1,this._hp=t.baseHp,this._maxHp=t.baseHp,this._energy=t.baseEnergy,this._maxEnergy=t.baseEnergy,this._coins=0,this._pendingTalentPoints=0,this._archers=n,this._spiders=new Map,this._arrows=new Map,this._abilities=s,this._isInvulnerable=!1,this._invulnerableTimer=0,this._freezeActive=!1,this._blizzardActive=!1,this._blizzardTimer=0,this._armageddonPhase="none",this._armageddonTimer=0,this._record=1,this._config=t}static createNew(e,t){const n=[];for(let i=0;i<9;i++)n.push(new ze(i,t.shootCooldown));const s=new Map,r=["freeze","blizzard","prep","heal","volley","stand","armageddon"];for(const i of r){const o=t.abilities[i];s.set(i,new Ge(i,Re[i],o.cooldown))}return new v(e,t,n,s)}get phase(){return this._phase}get difficulty(){return this._difficulty}get level(){return this._level}get levelTimer(){return this._levelTimer}get hp(){return this._hp}get maxHp(){return this._maxHp}get energy(){return this._energy}get maxEnergy(){return this._maxEnergy}get coins(){return this._coins}get pendingTalentPoints(){return this._pendingTalentPoints}get archers(){return this._archers}get spiders(){return this._spiders}get arrows(){return this._arrows}get abilities(){return this._abilities}get isInvulnerable(){return this._isInvulnerable}get invulnerableTimer(){return this._invulnerableTimer}get freezeActive(){return this._freezeActive}get blizzardActive(){return this._blizzardActive}get blizzardTimer(){return this._blizzardTimer}get armageddonPhase(){return this._armageddonPhase}get armageddonTimer(){return this._armageddonTimer}get record(){return this._record}get config(){return this._config}addSpider(e){this._spiders.set(e.id,e)}removeSpider(e){this._spiders.delete(e)}addArrow(e){this._arrows.set(e.id,e)}removeArrow(e){this._arrows.delete(e)}modifyHp(e){this._hp=Math.max(0,Math.min(this._maxHp,this._hp+e))}modifyEnergy(e){this._energy=Math.max(0,Math.min(this._maxEnergy,this._energy+e))}setPhase(e){this._phase=e}advanceLevel(){this._level+=1,this._levelTimer=this._config.levelTimerBase+this._config.levelTimerStep*this._level}addCoins(e){this._coins+=e}awardTalentPoint(){this._pendingTalentPoints+=1}spendTalentPoint(){this._pendingTalentPoints>0&&(this._pendingTalentPoints-=1)}updateRecord(){this._record=Math.max(this._record,this._level)}setInvulnerable(e){this._isInvulnerable=!0,this._invulnerableTimer=e}tickInvulnerable(e){this._isInvulnerable&&(this._invulnerableTimer-=e,this._invulnerableTimer<=0&&(this._invulnerableTimer=0,this._isInvulnerable=!1))}setBlizzard(e){this._blizzardActive=!0,this._blizzardTimer=e}tickBlizzard(e){this._blizzardActive&&(this._blizzardTimer-=e,this._blizzardTimer<=0&&(this._blizzardTimer=0,this._blizzardActive=!1))}setArmageddon(e,t){this._armageddonPhase=e,this._armageddonTimer=t??0}tickArmageddon(e){this._armageddonPhase!=="none"&&(this._armageddonTimer-=e,this._armageddonTimer<0&&(this._armageddonTimer=0))}setFreezeActive(e){this._freezeActive=e}getAbility(e){const t=this._abilities.get(e);if(!t)throw new Error(`Ability ${e} not found`);return t}setMaxHp(e){this._maxHp=e}setMaxEnergy(e){this._maxEnergy=e}setLevelTimer(e){this._levelTimer=e}setRecord(e){this._record=e}tickLevelTimer(e){this._levelTimer=Math.max(0,this._levelTimer-e)}}const L={baseHp:500,baseEnergy:100,hpRegen:1,energyRegen:10,coinsPerSec:2,shootCost:35,shootCooldown:1.5,arrowTravelTime:1.5,abilities:{freeze:{cost:50,cooldown:0},blizzard:{cost:40,cooldown:15},prep:{cost:0,cooldown:60},heal:{cost:100,cooldown:10},volley:{cost:100,cooldown:12},stand:{cost:15,cooldown:120},armageddon:{cost:100,cooldown:120}},levelTimerBase:15,levelTimerStep:2,spawnTickInterval:.02,spawnP0:.004,spawnDP:2e-4,spiderSpeedBase:.08,spiderSpeedStep:.004,spiderDamageBase:15,spiderDamageStep:2,spiderVariance:.3,spiderChanceFat:.05,spiderChanceFast:.03,spiderChanceNinja:.02,spiderChanceBurner:.01,talents:{endurance:{maxRanks:7,unlocksAtLevel:1},spiderArmor:{maxRanks:10,unlocksAtLevel:10},tireless:{maxRanks:5,unlocksAtLevel:1},agility:{maxRanks:5,unlocksAtLevel:10},healBoost:{maxRanks:15,unlocksAtLevel:30},hunterMastery:{maxRanks:10,unlocksAtLevel:1},improvedPrep:{maxRanks:5,unlocksAtLevel:20},volleyMastery:{maxRanks:5,unlocksAtLevel:20},rapidFire:{maxRanks:7,unlocksAtLevel:10},dutyBound:{maxRanks:5,unlocksAtLevel:20},blizzardMastery:{maxRanks:6,unlocksAtLevel:30}}},Ne={...L,coinsPerSec:1,spiderSpeedBase:.07,spiderSpeedStep:.003,spiderDamageBase:12,spiderDamageStep:1.5,spawnP0:.003,spawnDP:15e-5},Fe={...L,coinsPerSec:3,spiderSpeedBase:.09,spiderSpeedStep:.005,spiderDamageBase:18,spiderDamageStep:2.5,spawnP0:.005,spawnDP:25e-5};class z{getConfig(e){switch(e){case"easy":return Ne;case"normal":return L;case"hard":return Fe}}}class R{_config;constructor(e){this._config=e}levelDuration(e){return this._config.levelTimerBase+this._config.levelTimerStep*e}spiderBaseSpeed(e){return this._config.spiderSpeedBase+this._config.spiderSpeedStep*(e-1)}spiderBaseDamage(e){return this._config.spiderDamageBase+this._config.spiderDamageStep*(e-1)}spawnProbability(e){return this._config.spawnP0+this._config.spawnDP*(e-1)}randomVariance(){const e=this._config.spiderVariance;return 1-e+Math.random()*2*e}randomInt(e,t){const n=Math.ceil(e),s=Math.floor(t);return Math.floor(Math.random()*(s-n+1))+n}}class p{_id=crypto.randomUUID();get id(){return this._id}_lane;_y;_speed;_damage;_slowFactor;_slowTimer;_dying;_dyingTimer;_armageddonDelay;constructor(e,t=0,n,s){this._lane=e,this._y=t,this._speed=n,this._damage=s,this._slowFactor=1,this._slowTimer=0,this._dying=!1,this._dyingTimer=0,this._armageddonDelay=null}get lane(){return this._lane}get y(){return this._y}get speed(){return this._speed}get damage(){return this._damage}get slowFactor(){return this._slowFactor}get slowTimer(){return this._slowTimer}get dying(){return this._dying}get dyingTimer(){return this._dyingTimer}get armageddonDelay(){return this._armageddonDelay}get isAlive(){return!this._dying}get effectiveSpeed(){return this._speed*this._slowFactor}move(e){this._y+=this.effectiveSpeed*e}applySlow(e,t){this._slowFactor=e,this._slowTimer=t}tickSlow(e){this._slowTimer-=e,this._slowTimer<=0&&(this._slowTimer=0,this._slowFactor=1)}startDying(e=.3){this._dying=!0,this._dyingTimer=e}tickDying(e){this._dyingTimer-=e}changeLane(e){this._lane=e}scheduleArmageddon(e){this._armageddonDelay=e}tickArmageddon(e){return this._armageddonDelay===null?!1:(this._armageddonDelay-=e,this._armageddonDelay<=0?(this._armageddonDelay=null,!0):!1)}static computeBaseSpeed(e,t){return(e.spiderSpeedBase+e.spiderSpeedStep*(t-1))*(.7+Math.random()*.6)}static computeBaseDamage(e,t){return(e.spiderDamageBase+e.spiderDamageStep*(t-1))*(.7+Math.random()*.6)}}class M extends p{type="normal";static create(e,t,n){const s=p.computeBaseSpeed(n,t),r=p.computeBaseDamage(n,t);return new M(e,0,s,r)}}class C extends p{type="fat";static create(e,t,n){const s=p.computeBaseSpeed(n,t),r=p.computeBaseDamage(n,t);return new C(e,0,s,r)}}class T extends p{type="fast";static create(e,t,n){const s=p.computeBaseSpeed(n,t),r=p.computeBaseDamage(n,t),i=s*2,o=r*.5;return new T(e,0,i,o)}}class B extends p{type="burner";static create(e,t,n){const s=p.computeBaseSpeed(n,t),i=p.computeBaseDamage(n,t)*.1;return new B(e,0,s,i)}}class k extends p{type="ninja";_hasJumped=!1;_jumpThreshold;constructor(e,t,n,s,r){super(e,t,n,s),this._jumpThreshold=r}get hasJumped(){return this._hasJumped}get jumpThreshold(){return this._jumpThreshold}markJumped(){this._hasJumped=!0}static create(e,t,n){const s=p.computeBaseSpeed(n,t),r=p.computeBaseDamage(n,t),i=.1+Math.random()*.4;return new k(e,0,s,r,i)}}class x{_formula;_config;_spawnAccumulator=0;constructor(e,t){this._formula=e,this._config=t}tick(e,t){this._spawnAccumulator+=e;const n=this._config.spawnTickInterval,s=t.level;for(;this._spawnAccumulator>=n;){this._spawnAccumulator-=n;for(let r=0;r<9;r++){const i=this._formula.spawnProbability(s);if(Math.random()>=i)continue;const o=x.createSpider(r,s,this._config);t.addSpider(o)}}}reset(){this._spawnAccumulator=0}static createSpider(e,t,n){return t>=35&&Math.random()<.02?k.create(e,t,n):t>=20&&Math.random()<.03?T.create(e,t,n):t>=10&&Math.random()<.05?C.create(e,t,n):t>=5&&Math.random()<.01?B.create(e,t,n):M.create(e,t,n)}}const Pe=.05;class N{constructor(){}tick(e,t){const n=[];for(const[s,r]of t.arrows){if(r.move(e),r.hasLeft){n.push(s);continue}const i=this.findHitSpider(r,t);i!==null&&(i.startDying(),n.push(s))}for(const s of n)t.removeArrow(s)}checkCollisions(e){const t=[];for(const[n,s]of e.arrows){if(s.hasLeft)continue;const r=this.findHitSpider(s,e);r!==null&&(r.startDying(),t.push(n))}for(const n of t)e.removeArrow(n)}findHitSpider(e,t){let n=null;for(const[,s]of t.spiders)s.dying||s.lane!==e.lane||Math.abs(e.y-s.y)>=Pe||(n===null||s.y>n.y)&&(n=s);return n}}class b{_id=crypto.randomUUID();_lane;_y;_speed;_fromVolley;constructor(e,t,n=!1){this._lane=e,this._y=1,this._speed=t,this._fromVolley=n}get id(){return this._id}get lane(){return this._lane}get y(){return this._y}get fromVolley(){return this._fromVolley}get hasLeft(){return this._y<0}move(e){this._y-=this._speed*e}static create(e,t,n=1,s=!1){const r=1/t.arrowTravelTime*n;return new b(e,r,s)}}const De=50,Qe=.4,Ie=4,He=300,$e=150,Oe=4,Ue=7,Ze=1.7;class F{_config;_formulaCalculator;_talentSystem;_armageddonPendingIds=new Set;constructor(e,t,n){this._config=e,this._formulaCalculator=t,this._talentSystem=n}tick(e,t){const n=["freeze","blizzard","prep","heal","volley","stand","armageddon"];for(const s of n)t.getAbility(s).tick(e);t.tickInvulnerable(e),t.tickBlizzard(e),this._tickArmageddon(e,t),this._handleBlizzardSlowExpiration(e,t)}_tickArmageddon(e,t){if(t.armageddonPhase==="charging"){if(t.tickArmageddon(e),t.armageddonTimer<=0){t.setArmageddon("firing"),this._armageddonPendingIds.clear();for(const n of t.spiders.values())n.scheduleArmageddon(Math.random()*2),this._armageddonPendingIds.add(n.id)}return}if(t.armageddonPhase==="firing"){for(const s of t.spiders.values())this._armageddonPendingIds.has(s.id)&&s.tickArmageddon(e)&&(this._armageddonPendingIds.delete(s.id),s.startDying());const n=[];for(const s of this._armageddonPendingIds)t.spiders.has(s)||n.push(s);for(const s of n)this._armageddonPendingIds.delete(s);this._armageddonPendingIds.size===0&&t.setArmageddon("none")}}_handleBlizzardSlowExpiration(e,t){for(const n of t.spiders.values())n.tickSlow(e)}activateFreeze(e){if(e.freezeActive)return this.deactivateFreeze(e),!0;const t=De;return e.energy<t?!1:(e.modifyEnergy(-t),e.setPhase("paused"),e.setFreezeActive(!0),!0)}deactivateFreeze(e){e.setFreezeActive(!1),e.setPhase("playing")}activateBlizzard(e){if(e.level<8)return!1;const n=e.getAbility("blizzard");if(n.isOnCooldown)return!1;const s=this._config.abilities.blizzard.cost;if(e.energy<s)return!1;e.modifyEnergy(-s),n.activate(this._config.abilities.blizzard.cooldown);const r=this._talentSystem.getBlizzardSlowBonus(),i=1-Qe-r,o=this._talentSystem.getBlizzardDurationBonus(),d=Ie+o;for(const c of e.spiders.values())c.applySlow(i,d);return e.setBlizzard(d),!0}activatePrep(e){if(e.level<12)return!1;const n=e.getAbility("prep");if(n.isOnCooldown)return!1;const s=this._config.abilities.prep.cooldown,r=this._talentSystem.getPrepCooldownReduction(),i=Math.max(0,s-r);return n.activate(i),e.modifyEnergy(He),!0}activateHeal(e){if(e.level<16)return!1;const n=e.getAbility("heal");if(n.isOnCooldown)return!1;const s=this._config.abilities.heal.cost;if(e.energy<s)return!1;e.modifyEnergy(-s),n.activate(this._config.abilities.heal.cooldown);const r=this._talentSystem.getHealBonus(),i=$e+r;return e.modifyHp(i),!0}activateVolley(e){if(e.level<20)return!1;const n=e.getAbility("volley");if(n.isOnCooldown)return!1;const s=this._config.abilities.volley.cost;if(e.energy<s)return!1;const r=this._config.abilities.volley.cooldown,i=this._talentSystem.getShootCooldownMultiplier(),o=r*i;e.modifyEnergy(-s),n.activate(o);const d=this._talentSystem.getVolleyExtraLanes(),c=Oe+d,_=this._talentSystem.getArrowSpeedMultiplier(),y=this._pickRandomLanes(Math.min(c,9),9),a=e.config;for(const h of y){const H=b.create(h,a,_,!0);e.addArrow(H)}return!0}activateStand(e){if(e.level<24)return!1;const n=e.getAbility("stand");if(n.isOnCooldown)return!1;const s=this._config.abilities.stand.cost;if(e.energy<s)return!1;const r=this._config.abilities.stand.cooldown,i=this._talentSystem.getStandCooldownReduction(),o=Math.max(0,r-i);e.modifyEnergy(-s),n.activate(o);const d=this._talentSystem.getStandDurationBonus(),c=Ue+d;return e.setInvulnerable(c),!0}activateArmageddon(e){if(e.level<28)return!1;const n=e.getAbility("armageddon");if(n.isOnCooldown)return!1;const s=this._config.abilities.armageddon.cost;return e.energy<s?!1:(e.modifyEnergy(-s),n.activate(this._config.abilities.armageddon.cooldown),e.setArmageddon("charging",Ze),!0)}_pickRandomLanes(e,t){const n=Array.from({length:t},(r,i)=>i),s=[];for(let r=0;r<e&&n.length>0;r++){const i=this._formulaCalculator.randomInt(0,n.length-1);s.push(n[i]),n.splice(i,1)}return s}}class P{_talents;constructor(e){this._talents=new Map;const t=["endurance","spiderArmor","tireless","agility","healBoost","hunterMastery","improvedPrep","volleyMastery","rapidFire","dutyBound","blizzardMastery"];for(const n of t){const s=e.talents[n];this._talents.set(n,{id:n,rank:0,maxRanks:s.maxRanks,unlocksAtLevel:s.unlocksAtLevel})}}get talents(){return[...this._talents.values()]}getTalent(e){const t=this._talents.get(e);if(!t)throw new Error(`Talent ${e} not found`);return t}canUpgrade(e,t){const n=this.getTalent(e);return n.rank<n.maxRanks&&t>=n.unlocksAtLevel}upgrade(e){const t=this.getTalent(e);this._talents.set(e,{...t,rank:t.rank+1})}hasAvailableUpgrades(e){return this.talents.some(t=>this.canUpgrade(t.id,e))}getRank(e){return this.getTalent(e).rank}getMaxHpBonus(){return this.getRank("endurance")*425}getDamageReduction(){return this.getRank("spiderArmor")*.07}getEnergyRegenMultiplier(){return 1+this.getRank("tireless")*.1}getMaxEnergyBonus(){return this.getRank("agility")*120}getHealBonus(){return this.getRank("healBoost")*150}getHpRegenBonus(){return this.getRank("healBoost")*2}getShootCostReduction(){return this.getRank("hunterMastery")*2}getPrepCooldownReduction(){return this.getRank("improvedPrep")*6}getVolleyExtraLanes(){return this.getRank("volleyMastery")*1}getShootCooldownMultiplier(){return Math.max(.3,1-this.getRank("rapidFire")*.1)}getArrowSpeedMultiplier(){return 1+this.getRank("rapidFire")*.1}getStandDurationBonus(){return this.getRank("dutyBound")*1}getStandCooldownReduction(){return this.getRank("dutyBound")*12}getBlizzardSlowBonus(){return this.getRank("blizzardMastery")*.07}getBlizzardDurationBonus(){return this.getRank("blizzardMastery")*1}loadFromSave(e){for(const t of e){const n=t.id,s=this._talents.get(n);if(s){const r=Math.min(Math.max(0,t.rank),s.maxRanks);this._talents.set(n,{...s,rank:r})}}}toSaveData(){return this.talents.map(e=>({id:e.id,rank:e.rank}))}}const w="hvs_save",D=1;class je{save(e,t){const n={version:D,difficulty:e.difficulty,level:e.level,hp:e.hp,energy:e.energy,coins:e.coins,pendingTalentPoints:e.pendingTalentPoints,talents:t.toSaveData(),record:e.record},s=JSON.stringify(n);localStorage.setItem(w,s)}load(){const e=localStorage.getItem(w);if(e===null)return null;let t;try{t=JSON.parse(e)}catch{return this.clear(),null}return t.version!==D?(this.clear(),null):t}hasSave(){return localStorage.getItem(w)!==null}clear(){localStorage.removeItem(w)}getRecord(){const e=this.load();return e===null?0:e.record??0}}const qe=.1,Ve=1,Ke=3;class Ye{_state=null;_config=null;_formula=null;_spawner=null;_arrowSystem=null;_abilitySystem=null;_talentSystem=null;_saveSystem;_renderCallback;_phaseChangeCallback=null;_lastTimestamp=-1;_animFrameId=0;_reachedCastleSpiderIds=new Set;_prevPhase="menu";_coinAccumulator=0;constructor(e){this._saveSystem=new je,this._renderCallback=e}setPhaseChangeCallback(e){this._phaseChangeCallback=e}startNewGame(e){const t=new z;this._config=t.getConfig(e),this._saveSystem.clear(),this._formula=new R(this._config),this._spawner=new x(this._formula,this._config),this._arrowSystem=new N,this._talentSystem=new P(this._config),this._abilitySystem=new F(this._config,this._formula,this._talentSystem),this._state=v.createNew(e,this._config),this._applyTalentBonuses(),this._state.setPhase("playing"),this._state.setLevelTimer(this._config.levelTimerBase+this._config.levelTimerStep*this._state.level),this._lastTimestamp=-1,this._coinAccumulator=0,this._reachedCastleSpiderIds.clear(),this._prevPhase="playing",this._startLoop()}loadGame(){const e=this._saveSystem.load();if(e===null)return!1;const t=new z,n=e.difficulty;this._config=t.getConfig(n),this._formula=new R(this._config),this._spawner=new x(this._formula,this._config),this._arrowSystem=new N,this._talentSystem=new P(this._config),this._abilitySystem=new F(this._config,this._formula,this._talentSystem),this._talentSystem.loadFromSave([...e.talents]),this._state=v.createNew(n,this._config);for(let s=0;s<e.level-1;s++)this._state.advanceLevel();this._applyTalentBonuses(),this._state.modifyHp(e.hp-this._state.hp),this._state.modifyEnergy(e.energy-this._state.energy),this._state.addCoins(e.coins);for(let s=0;s<e.pendingTalentPoints;s++)this._state.awardTalentPoint();return this._state.setRecord(e.record),this._state.setPhase("playing"),this._lastTimestamp=-1,this._coinAccumulator=0,this._reachedCastleSpiderIds.clear(),this._prevPhase="playing",this._startLoop(),!0}shootLane(e){const t=this._state;if(t===null||this._config===null||this._talentSystem===null||t.phase!=="playing")return;const n=t.archers[e];if(n===void 0||!n.isReady)return;const s=this._config.shootCost-this._talentSystem.getShootCostReduction();if(t.energy<s)return;t.modifyEnergy(-s);const r=this._config.shootCooldown*this._talentSystem.getShootCooldownMultiplier();n.startCooldown(r);const i=this._talentSystem.getArrowSpeedMultiplier(),o=b.create(e,this._config,i,!1);t.addArrow(o)}activateAbility(e){const t=this._state;if(t===null||this._abilitySystem===null)return!1;if(e==="freeze")return t.phase!=="playing"&&t.phase!=="paused"?!1:this._abilitySystem.activateFreeze(t);if(t.phase!=="playing")return!1;switch(e){case"blizzard":return this._abilitySystem.activateBlizzard(t);case"prep":return this._abilitySystem.activatePrep(t);case"heal":return this._abilitySystem.activateHeal(t);case"volley":return this._abilitySystem.activateVolley(t);case"stand":return this._abilitySystem.activateStand(t);case"armageddon":return this._abilitySystem.activateArmageddon(t);default:return!1}}confirmLevelUp(){const e=this._state;e===null||this._config===null||this._talentSystem===null||e.phase!=="levelUp"||(e.advanceLevel(),e.setLevelTimer(this._config.levelTimerBase+this._config.levelTimerStep*e.level),this._applyTalentBonuses(),this._saveSystem.save(e,this._talentSystem),e.setPhase("playing"))}getState(){return this._state}getTalentSystem(){return this._talentSystem}getSaveSystem(){return this._saveSystem}_gameLoop(e){const t=this._state;if(t===null)return;let n;this._lastTimestamp<0?(n=0,this._lastTimestamp=e):(n=Math.min((e-this._lastTimestamp)/1e3,.1),this._lastTimestamp=e),t.phase==="playing"&&this._tick(n),this._renderCallback(t),this._detectPhaseChange(t),t.phase!=="gameOver"&&(this._animFrameId=requestAnimationFrame(s=>this._gameLoop(s)))}_detectPhaseChange(e){if(e.phase!==this._prevPhase){const t=e.phase;this._prevPhase=t,this._phaseChangeCallback?.(t,e)}}_tick(e){const t=this._state,n=this._config,s=this._spawner,r=this._arrowSystem,i=this._abilitySystem,o=this._talentSystem,d=this._formula;if(t===null||n===null||s===null||r===null||i===null||o===null||d===null)return;s.tick(e,t);for(const[,a]of t.spiders)a.dying||(this._handleNinjaJump(a,t),a.move(e));r.tick(e,t),i.tick(e,t);const c=n.hpRegen+o.getHpRegenBonus();t.modifyHp(c*e);const _=n.energyRegen*o.getEnergyRegenMultiplier();if(t.modifyEnergy(_*e),this._coinAccumulator+=n.coinsPerSec*e,this._coinAccumulator>=1){const a=Math.floor(this._coinAccumulator);t.addCoins(a),this._coinAccumulator-=a}for(const a of t.archers)a.tick(e);const y=o.getDamageReduction();for(const[,a]of t.spiders)if(!(a.dying||a.y<1)){if(this._reachedCastleSpiderIds.add(a.id),!t.isInvulnerable){const h=a.damage*(1-y);a.type==="burner"?(t.modifyHp(-h*qe),t.modifyEnergy(-90)):t.modifyHp(-h)}a.startDying()}this._processDyingSpiders(t,d,e),t.tickLevelTimer(e),t.levelTimer<=0&&(t.setPhase("levelUp"),t.awardTalentPoint(),t.updateRecord(),this._saveSystem.save(t,o)),t.hp<=0&&t.setPhase("gameOver")}_handleNinjaJump(e,t){if(!(e instanceof k))return;const n=e;if(n.hasJumped||n.y<n.jumpThreshold)return;let s;n.lane===0?s=1:n.lane===8?s=7:s=n.lane+(Math.random()<.5?-1:1),n.changeLane(s),n.markJumped()}_processDyingSpiders(e,t,n){const s=[];for(const[r,i]of e.spiders)if(i.dying&&(i.tickDying(n),i.dyingTimer<=0)){if(s.push(r),!this._reachedCastleSpiderIds.has(r)){const o=t.randomInt(Ve,Ke);e.addCoins(o)}this._reachedCastleSpiderIds.delete(r)}for(const r of s)e.removeSpider(r)}_applyTalentBonuses(){const e=this._state,t=this._config,n=this._talentSystem;e===null||t===null||n===null||(e.setMaxHp(t.baseHp+n.getMaxHpBonus()),e.setMaxEnergy(t.baseEnergy+n.getMaxEnergyBonus()))}stopLoop(){cancelAnimationFrame(this._animFrameId)}_startLoop(){this._animFrameId=requestAnimationFrame(e=>this._gameLoop(e))}}class Je{_onShoot;_onAbility;_enabled;_boundKeydown;constructor(e,t){this._onShoot=e,this._onAbility=t,this._enabled=!0,this._boundKeydown=this._handleKeydown.bind(this),window.addEventListener("keydown",this._boundKeydown)}_handleKeydown(e){if(!this._enabled)return;const t=e.key.toLowerCase(),n=e.code;if(t>="1"&&t<="9"){this._onShoot(parseInt(t,10)-1);return}const s={q:"freeze",w:"blizzard",e:"prep",r:"heal",t:"volley",y:"stand",u:"armageddon",й:"freeze",ц:"blizzard",у:"prep",к:"heal",е:"volley",н:"stand",г:"armageddon"},r={KeyQ:"freeze",KeyW:"blizzard",KeyE:"prep",KeyR:"heal",KeyT:"volley",KeyY:"stand",KeyU:"armageddon"},i=s[t]??r[n];i&&this._onAbility(i)}setEnabled(e){this._enabled=e}destroy(){window.removeEventListener("keydown",this._boundKeydown)}}class We{_container;_visible=!1;constructor(e,t){this._container=this._createDOM(e,t)}_createDOM(e,t){const n=document.createElement("div");n.className="freeze-overlay";const s=document.createElement("div");s.className="freeze-overlay__snowflake",s.innerHTML=t.get("Snowflake");const r=document.createElement("div");r.className="freeze-overlay__text",r.textContent="ЗАМОРОЗКА";const i=document.createElement("div");return i.className="freeze-overlay__hint",i.textContent="Нажмите Q чтобы продолжить",n.appendChild(s),n.appendChild(r),n.appendChild(i),e.appendChild(n),n}show(){this._container.style.display="flex",this._container.classList.add("active"),this._visible=!0}hide(){this._container.style.display="none",this._container.classList.remove("active"),this._visible=!1}isVisible(){return this._visible}}class Xe{_container;_visible=!1;constructor(e){this._container=this._createDOM(e)}_createDOM(e){const t=document.createElement("div");t.className="armageddon-overlay";const n=document.createElement("div");n.className="armageddon-overlay__fire";const s=document.createElement("div");return s.className="armageddon-overlay__text",s.textContent="АРМАГЕДДОН",t.appendChild(n),t.appendChild(s),e.appendChild(t),t}show(){this._container.style.display="flex",this._container.classList.add("active"),this._visible=!0}hide(){this._container.style.display="none",this._container.classList.remove("active"),this._visible=!1}isVisible(){return this._visible}}const I=document.getElementById("app");if(!I)throw new Error("Root element #app not found");const E=new ge;E.loadAll();const u=new Ae(I,E);let g=null,m=null;const f=new Ye(l=>{u.renderGameState(l),g&&(l.freezeActive?g.show():g.hide()),m&&(l.armageddonPhase==="firing"?m.show():m.hide())});f.setPhaseChangeCallback((l,e)=>{if(l==="gameOver"){const t=Math.max(e.record,e.level),n=e.level>=e.record;u.showGameOver(e.level,t,n)}else if(l==="levelUp"){const t=f.getTalentSystem(),n=f.getState();t&&n&&u.showLevelUp(e.level,t,e.pendingTalentPoints,()=>{f.confirmLevelUp(),u.getLevelUpScreen().hide()},()=>{n.spendTalentPoint()})}});u.setEngine({startNewGame:l=>{f.startNewGame(l),Q()},loadGame:()=>{f.loadGame(),Q()}});u.setSaveSystem(f.getSaveSystem());u.init();new Je(l=>f.shootLane(l),l=>f.activateAbility(l));function Q(){const e=u.getGameScreen().getGameField().getContainer();g||(g=new We(e,E)),m||(m=new Xe(e));const t=f.getTalentSystem();t&&u.getGameScreen().getHud().setTalentSystem(t)}const et=u.getGameScreen().getGameField().getArchersRow();et.addEventListener("click",l=>{const e=l.target.closest(".archer-btn");if(!e)return;const t=parseInt(e.dataset.lane??"",10);isNaN(t)||f.shootLane(t)});const tt=u.getGameScreen().getHud().getAbilityButtonsContainer();tt.addEventListener("click",l=>{const e=l.target.closest(".ability-btn");if(!e)return;const t=e.dataset.ability;t&&f.activateAbility(t)});
